...
const ENGLISH_TEXT = {
  ...
  report: {
    ...
    includeDimensionalSummary: 'Include dimensional summary',
    includeRegimeAssessment: 'Include applicability assessment',
    includeSampledStateTable: 'Include sampled state table',
    includeComparisonCases: 'Include saved model cases',
    includeDataOverlays: 'Include data overlays',
    includeTipPenetration: 'Include tip penetration',
...
export const TRANSLATIONS: Record<Language, UiText> = {
  ...
  ja: {
    ...
    report: {
      ...
      includeDimensionalSummary: '次元付き概要を含める',
      includeRegimeAssessment: '適用性評価を含める',
      includeSampledStateTable: 'サンプル状態表を含める',
      includeComparisonCases: '保存した比較ケースを含める',
      includeDataOverlays: 'データ重ね合わせを含める',
      includeTipPenetration: '先端到達距離を含める',
  ...
  es: {
    ...
    report: {
      eyebrow: 'Nota técnica',
      title: 'Generador de reportes',
      reportTitle: 'Título del reporte',
      author: 'Autor',
      preview: 'Previsualizar reporte',
      print: 'Imprimir / guardar como PDF',
      downloadMarkdown: 'Descargar Markdown',
      downloadHtml: 'Descargar HTML',
      includeDimensionalSummary: 'Incluir resumen dimensional',
      includeRegimeAssessment: 'Incluir evaluación de aplicabilidad',
      includeSampledStateTable: 'Incluir tabla de estados muestreados',
      includeComparisonCases: 'Incluir casos de comparación guardados',
      includeDataOverlays: 'Incluir datos superpuestos',
      includeTipPenetration: 'Incluir penetración de la punta',
